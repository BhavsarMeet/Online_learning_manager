                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style="padding-top: 60px;">
                    ...
                    <div class="page__heading border-bottom">
                        <div class="container-fluid page__container d-flex align-items-center">
                            <h1 class="mb-0">Quiz Manager</h1>
                            <a href="/quiz/gotoAddNewQuiz?id=${courseId }" class="btn btn-success ml-auto"><i class="material-icons">add</i> New Quiz</a>
                        </div>
                    </div>
${quiznotfound}
                                ...
                                <div class="card-body media">
                                    <div class="media-left">
                                        <a href="#" class="avatar avatar-lg mr-1">
                                            <img src="/images/logos/vuejs.svg" alt="Card image cap" class="avatar-course-img">
                                        </a>
                                    </div>
                                    <div class="media-body align-self-center">
                                        <h4 class="card-title mb-0"><a href="#">${quiz.quizTitle}</a></h4>
                                        <span class="text-muted">${quiz.quizMarks} Marks</span>
                                    </div>
                                </div>
                                <div class="card-footer d-flex bg-light">
                                    <div>
                                        <a href="#" class="btn btn-light btn-sm">Pending Review <span class="badge badge-soft-secondary ml-1">5</span></a>
                                    </div>
                                    <div class="ml-auto">
                                        <a href="/question/getViewQuestion/${quiz.quizId}" class="btn btn-primary btn-sm"><i class="material-icons icon-16pt">visibility</i> View </a>
                                    </div>
                                </div>
                            </div>
						</c:forEach>
