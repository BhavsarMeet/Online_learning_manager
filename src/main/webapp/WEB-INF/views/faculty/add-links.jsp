        ...
        <div class="mdk-drawer-layout__content">
            ...
            <div class="mdk-header-layout js-mdk-header-layout" data-has-scrolling-region>
                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style="padding-top: 60px;">
                    ...
                    <form action="/teacher/addlink" method="post">
					 
					 <input type="hidden" name="id" value="${courseId}">
					  <div class="form-outline mb-4">
					  	<label class="form-label" for="form4Example1">Video Title</label>
					    <input type="text" id="form4Example1" name="videoTitle" class="form-control" />
					    
					  </div>
					
					  
					  <div class="form-outline mb-4">
					   <label class="form-label" for="form4Example3">Video Link</label>
					    <textarea class="form-control" id="form4Example3" name="videoLink" rows="4"></textarea>
					  </div>
