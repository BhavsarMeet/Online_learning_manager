                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style="padding-top: 60px;">
  				...
  				<thead class="thead-light">
    				<tr>
      				...
      				<th scope="col">View Assign Course</th>
				...
				<tbody>
				    <c:forEach items="${students}" var="list">
                        <tr>
                            ...
                            <td><a href="/admin/getCourses?studentId=${list.studentId}" class="btn btn-success"><i class="material-icons">add</i>Add Course</a></td>
                            <td><a href="/admin/viewCourseOfStudent?studentId=${list.studentId}" class="btn btn-secondary"><i class="material-icons">visibility</i> View</a></td>
                            <td><a href="/admin/viewstudentresult?studentId=${list.studentId}" class="btn btn-secondary"><i class="material-icons">visibility</i> View</a></td>
                            <td><a href="#" class="btn btn-danger"><i class="material-icons">delete</i>Delete</a>&nbsp;&nbsp; <a href="#" class="btn btn-primary"><i class="material-icons">edit</i> Update</a></td>
						</tr>
                    </c:forEach>
				  </tbody>
