                    ...
                    <div class="sidebar-block p-0">
                        <ul class="sidebar-menu mt-0">
                            <li class="sidebar-menu-item">
                             ...
                             <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="/course/courses">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="/admin/faculties">
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">person</i>
                                    <span class="sidebar-menu-text">Faculties</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="/admin/admin-edit?email=${admin.adminEmail }">
