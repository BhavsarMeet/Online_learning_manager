...
<!-- Mirrored from educate.frontted.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Jul 2021 12:40:09 GMT -->
<head>
    <meta charset="utf-8">
		...
		<span style="color:red ">${error}</span>
            ...
            <form action="checkOtp" method="post">
                <div class="form-group">
                        ...
                        <input type="hidden" name="eamil" value="${email}">
                     
                    <label class="text-label" for="email_2">One Time Password:</label>
                    <div class="input-group input-group-merge">
                        <input id="email_2" name="uotp" type="text" class="form-control form-control-prepended" placeholder="Enter OTP" required>
...
<!-- Mirrored from educate.frontted.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Jul 2021 12:40:10 GMT -->
</html>
