                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="/student/gotoCourseLessonList?id=${list.courseId }">${list.courseTitle}</a></h4>
                                                        <p class="text-muted">${list.courseDesc}</p>
                                                    </div>
                                            </div>
                                            <a href="getquizlist/${list.courseId}" class="btn btn-outline-primary">All Quiz</a>
                                        </div>
