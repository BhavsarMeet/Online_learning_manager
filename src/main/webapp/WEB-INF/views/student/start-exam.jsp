            ...
            <div class="mdk-header-layout js-mdk-header-layout" data-has-scrolling-region>
                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style="padding-top: 60px;">
                    ...
                    <div class="page__heading border-bottom">
                        <span style="size:50px; font-weight:bold; margin-left: 100px">quiz Marks:${quiz.quizMarks}</span>     
                        <span style="size:50px; font-weight:bold; margin-left: 100px">subject:${quiz.quizTitle}</span>          
                        <span style="size:50px; font-weight:bold; margin-left: 100px">Topic:${quiz.quizTopic}</span>
                    </div>



<form action="/student/evaluation">
							...
							<div class="card">
                                <div class="card-body media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <h5 class="card-title mb-0"><input type="hidden" name="quest" value="${ques.questionId }">${ques.question}</h5>
                                       		<tr><td><input type="radio" value="${ques.option1}" name="choice_${ques.questionId}" readonly>${ques.option1 }</td></tr> <br>
											<tr><td><input type="radio" value="${ques.option2}" name="choice_${ques.questionId }" readonly>${ques.option2 } </td></tr><br>
											<tr><td><input type="radio" value="${ques.option3}" name="choice_${ques.questionId }" readonly>${ques.option3 }</td></tr> <br>
											<tr><td><input type="radio" value="${ques.option4}" name="choice_${ques.questionId }" readonly>${ques.option4 }</td></tr> <br>
