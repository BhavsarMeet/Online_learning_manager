                                ...
                                <div class="row card-group-row">
                                        ...
                                        <div class="card card-group-row__card">
                                            <div class="card-body-x-lg card-body d-flex flex-row align-items-center">
                                                ...
                                                <a href="/student/courses">
                                                    ...
                                                    <span class="h4 m-0">${totalStudentCourse} </span>
                                                 </a>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 card-group-row__col">
                                        <div class="card card-group-row__card">
                                            <div class="card-body-x-lg card-body d-flex flex-row align-items-center">
                                                <div class="flex">
                                                <a href="/student/getResultDetails">
                                                    <div class="card-header__title text-muted d-flex mb-2">Results </div>
                                                    <span class="h4 m-0">${totalStudentResult }</span>
                                                 </a>
                                                </div>
                                                <div><i class="material-icons icon-muted icon-40pt ml-3">marksheet</i></div>
                                            </div>
                                            <div class="progress" style="height: 3px;">
