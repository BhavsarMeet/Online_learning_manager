                    ...
                    <div class="page__heading border-bottom">
                        <div class="container-fluid page__container d-flex align-items-center">
                            <h1 class="mb-0">Doubts And Solutions</h1>
                               <a href="/student/getadddoubt" class="btn btn-success ml-auto"><i class="material-icons"></i>Ask Doubt</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1">${doubts.doubtQues}</a></h4>
                                                        <p class="text-danger">${doubts.doubtAns}</p>
                                                    </div>
                                            </div>
