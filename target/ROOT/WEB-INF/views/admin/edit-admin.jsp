                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-8 card-form__body card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input id="fname" name="adminName" type="text" class="form-control" placeholder="First name" value="${admin.adminName}">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="lname">Email</label>
                                                <input id="lname" name="adminEmail" type="email" class="form-control" placeholder="Last name" value="${admin.adminEmail}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                                ...
                                                <input id="lname" name="adminPhone" type="text" class="form-control" placeholder="Last name" value="${admin.adminPhone}">
                                            </div>
                                </div>
                            </div>
                        </div>
