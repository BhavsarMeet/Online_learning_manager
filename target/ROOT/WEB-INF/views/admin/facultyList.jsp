    ...
    <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px" data-fullbleed>
        <div class="mdk-drawer-layout__content">
            ...
            <div class="mdk-header-layout js-mdk-header-layout" data-has-scrolling-region>
				...
				<tbody>
				   <c:forEach items="${faculties}" var="list">
                        <tr>
                            <td>${ list.teacherId}</td>
                            <td>${list.teacherName}</td>
                            <td>${list.teacherEmail}</td>
                            <td>${list.teacherPhone}</td>
                            <td><a href="/admin/viewCourseOfFaculty?facultyId=${list.teacherId}" class="btn btn-secondary"><i class="material-icons">visibility</i> View</a></td>
