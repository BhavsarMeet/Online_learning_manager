                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style="padding-top: 60px;">
                    ...
                    <div class="page__heading">
                        <div class="container-fluid page__container">
                            <h1 class="mb-0">Make Quiz</h1>
                        </div>
                    </div>
                    <center>
                    <div class="Container" style="width:500px;margin:20px">
                    <form action="/quiz/addQuiz" method="post">
					 <input type="hidden" name="courseId" value="${courseId}">
					  <div class="form-outline mb-4">
					  	<label class="form-label" for="form4Example1">Quiz Title</label>
					    <input type="text" id="form4Example1" name="quizTitle" class="form-control" />
					  </div>
					
					  <div class="form-outline mb-4">
					  	<label class="form-label" for="form4Example1">Quiz Marks</label>
					    <input type="text" id="form4Example1" name="quizMarks" class="form-control" />
					  </div>
					 
					  <div class="form-outline mb-4">
					   <label class="form-label" for="form4Example3">Quiz Topics</label>
					    <textarea class="form-control" id="form4Example3" name="quizTopic" rows="2"></textarea>
					  </div>
