                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style="padding-top: 60px;">
                    ...
                    <div class="page__heading border-bottom">
                        <div class="container-fluid page__container d-flex align-items-center">
                            ...
                            <a href="/teacher/getAddCourse" class="btn btn-success ml-auto"><i class="material-icons">add</i> New Course</a>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            <a href="gotoCourseLessonList?id=${list.courseId}" class="avatar mb-3 w-xs-plus-down-100 mr-sm-3">
                                                <img src="/images/logos/vuejs.svg" alt="Card image cap" class="avatar-course-img">
                                            </a>
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="gotoCourseLessonList?id=${list.courseId}">${list.courseTitle}</a></h4>
                                                        <p class="text-muted">${list.courseDesc}</p>
                                                    </div>
                                                    <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="gotoCourseLessonList?id=${list.courseId}">View Course</a>
