                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style="padding-top: 60px;">
                 ...
                 <%--    <div class="page__heading border-bottom">
                        <div class="container-fluid page__container d-flex align-items-center">
                            ...
                            <a href="/teacher/gotoAddLinks?id=${courseId}" class="btn btn-success ml-auto"><i class="material-icons">add</i> New Lesson</a>
                        </div>
                    </div>
 --%>
                                ...
                                <div class="">
                                    ...
                                    <c:forEach items="${lessons }" var="list">
                                    	<li class="list-group-item d-flex">
                                            <a href="playvideoadmin?link=${list.videoLink }&title=${list.videoTitle}&courseId=${courseId}">${list.videoTitle}</a>
