                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="#">${list.courseTitle}</a></h4>
                                                    ...
                                                    <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="/admin/gotoCourseLessonListAdmin?id=${list.courseId}">view details</a>
                                                    ...
                                                    <c:set var = "student" scope = "session" value = "${studentId}"/>
                             						<c:if test="${student != null}">
                                                    <div class="d-flex align-items-end">
                                                    <div class="d-flex flex flex-column mr-3">
                                                        <div class="d-flex align-items-center py-2 border-bottom">
                                                            <a href="/admin/assignCourse?courseId=${list.courseId}&studentId=${studentId}" class="mr-2 btn btn-danger"><i class="material-icons">add</i>Add</a>
