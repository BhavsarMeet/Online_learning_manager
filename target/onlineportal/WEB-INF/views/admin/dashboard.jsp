                                ...
                                <div class="row card-group-row">
                                        ...
                                        <div class="card card-group-row__card">
                                            <div class="card-body-x-lg card-body d-flex flex-row align-items-center">
                                                 ...
                                                 <a href="/admin/students" style="text-decoration:none">
                                                    <div class="card-header__title text-muted mb-2 d-flex">All Students<span class="badge badge-warning ml-2"></span></div>
                                                    <span class="h4 m-0">${totalStudent}</span>
                                                   </a>
                                                </div>
                                                  <div><i class="material-icons icon-muted icon-40pt ml-3">person</i></div>
                                                <div></div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 card-group-row__col">
                                        <div class="card card-group-row__card">
                                            <div class="card-body-x-lg card-body d-flex flex-row align-items-center">
                                                <div class="flex">
                                                <a href="/admin/faculties" style="text-decoration:none">
                                                    <div class="card-header__title text-muted  mb-2 d-flex">All Faculty<span class="badge badge-primary ml-2"></span></div>
                                                    <span class="h4 m-0">${totalFaculty}</span>
                                                </a>
                                                </div>
                                                <div><i class="material-icons icon-muted icon-40pt ml-3">person</i></div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 card-group-row__col">
                                        <div class="card card-group-row__card">
                                            <div class="card-body-x-lg card-body d-flex flex-row align-items-center">
                                                <div class="flex">
                                                <a href="/course/courses" style="text-decoration:none">
                                                    <div class="card-header__title text-muted mb-2">Courses</div>

                                                    <div class="d-flex align-items-center">
                                                        <div class="h4 m-0">${totalCourse }</div>
                                                 </a>
                                                    </div>
                                                </div>
