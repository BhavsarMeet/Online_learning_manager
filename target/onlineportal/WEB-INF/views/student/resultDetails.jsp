            ...
            <div class="mdk-header-layout js-mdk-header-layout" data-has-scrolling-region>
                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style="padding-top: 60px;">
                    ...
                    <div class="page__heading">
 					...
 					<% List<QuizBean> quizes =(List<QuizBean>)request.getAttribute("quizes");
						List<ResultBean> results =(List<ResultBean>)request.getAttribute("results");
					%>
				...
				<table class="table table-striped">
				  ...
				  <%for(int i=0;i<quizes.size();i++){ %>
				    <tr>
				      <td><%=quizes.get(i).getQuizTitle() %></td>
				      <td><%=quizes.get(i).getQuizTopic() %></td>
				      <td><%=quizes.get(i).getQuizMarks() %></td>
				      <td><%=results.get(i).getMarks() %></td>
				    </tr>
				   <%} %>
				  </tbody>
				</table>
