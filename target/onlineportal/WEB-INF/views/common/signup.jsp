...
<!-- Mirrored from educate.frontted.com/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Jul 2021 12:40:27 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="layout-login-centered-boxed__form">
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-4 navbar-light">
            <a href="index.html" class="navbar-brand text-center mb-2 mr-0 flex-column" style="min-width: 0">
                <!-- LOGO -->
                <svg width="40px" viewBox="0 0 27 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="card card-body">
            ...
            <form action="/register" novalidate method="post" >
          
                <div class="form-group">
                    <label class="text-label" for="name_2">Name:</label>
                    <div class="input-group input-group-merge">
                        <input id="name_2" name="name" type="text" required="" class="form-control form-control-prepended" placeholder="John Doe">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <span class="far fa-user"></span>
                            </div>
                        </div>
                        <form:errors path="schema.name"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <form:errors path="schema.email"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="text-label" for="email_2">Phone:</label>
                    <div class="input-group input-group-merge">
                        <input id="email_2" name="phone" type="text" required="" class="form-control form-control-prepended" placeholder="john@doe.com">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <span class="far fa-envelope"></span>
                            </div>
                        </div>
                        <form:errors path="schema.phone"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="text-label" for="name_2">Role:</label>
                    <div class="input-group input-group-merge">
                       <select id="inlineFormRole" name="role" class="custom-select mb-2 mr-sm-2 mb-sm-0">
                                        <option value="admin">Admin</option>
                                        <option value="teacher">Faculty</option>
                                        <option value="student">Student</option>
                      </select>
                    </div>
                    <form:errors path="schema.role"/>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <form:errors path="schema.password"/>
                    </div>
                </div>
