                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="viewquiz?courseId=${list.courseId }">${list.courseTitle}</a></h4>
                                                    ...
                                                    <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="gotoAddNewQuiz?id=${list.courseId}">Add Quiz</a>
                                                            <a class="dropdown-item" href="viewquiz?courseId=${list.courseId }">View Quiz</a>
