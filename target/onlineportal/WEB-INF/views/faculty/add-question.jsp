                    ...
                    <form action="/question/addQuestion" method="post">
					  ...
					  <div class="form-outline mb-4">
					   <label class="form-label" for="form4Example3">Question</label>
					    <textarea class="form-control" id="form4Example3" name="question" rows="2"></textarea>
					  </div>
					 ...
					 <input type="hidden" name="quizId" value="${quizId}">
					  <div class="form-outline mb-4">
					  	<label class="form-label" for="form4Example1">Option 2</label>
					    <input type="text" id="form4Example1" name="option2" class="form-control" />
					  </div>
					  
					  <div class="form-outline mb-4">
					  	<label class="form-label" for="form4Example1">Option 3</label>
					    <input type="text" id="form4Example1" name="option3" class="form-control" />
					  </div>
					  
					  <div class="form-outline mb-4">
					  	<label class="form-label" for="form4Example1">Option 4</label>
					    <input type="text" id="form4Example1" name="option4" class="form-control" />
					  </div>
					
						<div class="form-outline mb-4">
					  	<label class="form-label" for="form4Example1">Correct Answer</label>
					    <input type="text" id="form4Example1" name="correctOption" class="form-control" />
					  </div>
